              ...
              <video autoPlay loop muted playsInline className="absolute top-1/2 left-1/2 w-full h-full object-cover -translate-x-1/2 -translate-y-1/2 -z-10">
                ...
                <div id="overlay-content" className="relative mt-8 flex flex-col w-7/8 h-10/12 bg-background/30 z-50 backdrop-blur-md rounded-2xl items-center justify-center">
                    ...
                    <div id="submit-section" className="m-1 flex flex-wrap item-center justify-end justify-items-end gap-40">
                        ...
                        <button dir="rtl" id="clear-button" className="box-border h-10 w-40 border-4 border-radius rounded-3xl border-reject bg-reject hover:border-[#E90000] hover:bg-[#E90000] cursor-pointer transition-transform delay-150 duration-300 ease-out hover:scale-110">
